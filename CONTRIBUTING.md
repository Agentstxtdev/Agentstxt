...
- agentstxt is the **spec + reference deployment**. It is *not* the place for the `agentify` toolkit; that lives in a sibling project. Do not import `@agentify/*` anywhere here.
